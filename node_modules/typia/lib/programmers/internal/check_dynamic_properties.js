...
var check_dynamic_properties = function (props) {
    return function (importer) {
        return function (input, regular, dynamic) {
            var length = IdentifierFactory_1.IdentifierFactory.join(typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("Object.keys"), undefined, [input]), "length");
            ...
            var criteria = props.entries
                ...
                : typescript_1.default.factory.createCallExpression(IdentifierFactory_1.IdentifierFactory.join(typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("Object.keys"), undefined, [input]), props.assert ? "every" : "map"), undefined, [check_dynamic_property(props)(input, regular, dynamic)]);
