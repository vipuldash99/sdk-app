    ...
    return function (components) {
        return function (tuple) {
            return function (metadata, nullable, attribute) {
                var e_1, _a;
                var output = __assign({ type: "array", items: (0, application_schema_1.application_schema)(options)(components)(false)(metadata, attribute), nullable: nullable, "x-typia-tuple": tuple }, attribute);
                try {
