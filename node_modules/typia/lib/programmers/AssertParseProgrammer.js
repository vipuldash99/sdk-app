    ...
    AssertParseProgrammer.generate = function (project, modulo) {
        return function (type, name) {
            return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                ...
                StatementFactory_1.StatementFactory.constant("assert", AssertProgrammer_1.AssertProgrammer.generate(__assign(__assign({}, project), { options: __assign(__assign({}, project.options), { functional: false, numeric: false }) }), modulo)(type, name)),
