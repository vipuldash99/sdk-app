...
export declare namespace IsProgrammer {
    ...
    function generate(project: IProject, modulo: ts.LeftHandSideExpression, equals?: boolean): (type: ts.Type, name?: string | undefined) => ts.ArrowFunction;
    ...
    function decode_to_json(input: ts.Expression, checkNull: boolean): ts.Expression;
